...
public class AudioListener {
	...
	public static void load(String s, String n) {
		...
		Clip clip ;
		try {			
			AudioInputStream ais= AudioSystem.getAudioInputStream(AudioListener.class.getResourceAsStream(s));
	...
	public static  Set<Entry<String, Clip>> getSize(){
		return clips.entrySet();
	}
	public static void setVolume(String s, float f){
		FloatControl gainControl = 
			    (FloatControl) clips.get(s).getControl(FloatControl.Type.MASTER_GAIN);
